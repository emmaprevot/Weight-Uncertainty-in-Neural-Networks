...
class SGD_Hyper(object):
    ...
    def __init__(self, ):
        ...
        self.LOADER_KWARGS = {'num_workers': 1, 'pin_memory': True} if torch.backends.mps.is_available() else {}
...
def SGD_run(hyper, train_loader=None, valid_loader=None, test_loader=None):
    ...
    """Save"""
    path = 'Results/SGD/SGD_' + hyper.dataset + '_' + hyper.mode + '_' + str(hyper.hidden_units) + '_' + str(hyper.lr)+ '_' + str(hyper.momentum)
